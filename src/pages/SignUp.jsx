      ...
      >
        ...
        {step === 1 && (
          <>
            ...
            <input name="email" placeholder="Email" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.email} />
        ...
        {step === 2 && (
          <>
            ...
            <input name="name" placeholder="Name" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.name} />
            {errors.name && <p className="text-red-500 text-sm">{errors.name}</p>}
            <input name="age" type="number" placeholder="Age" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.age} />
            {errors.age && <p className="text-red-500 text-sm">{errors.age}</p>}
            <select name="gender" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.gender}>
            ...
            <input name="weight" type="number" placeholder="Weight (kg)" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.weight} />
            {errors.weight && <p className="text-red-500 text-sm">{errors.weight}</p>}
            <input name="height" type="number" placeholder="Height (cm)" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.height} />
            {errors.height && <p className="text-red-500 text-sm">{errors.height}</p>}
            <select name="goal" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.goal}>
            ...
            <select name="dietaryPreferences" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.dietaryPreferences}>
            ...
            <select name="activityLevel" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.activityLevel}>
            ...
            <input name="medicalConditions" placeholder="Medical Conditions (if any)" className="w-full p-2 rounded-md mb-3 bg-gray-700 text-white" onChange={handleChange} value={formData.medicalConditions} />
            <button className="w-full py-2 rounded-full bg-purple-500 hover:bg-purple-600 font-bold" onClick={handleRegister}>
              Register
            </button>
          </>
        )}
